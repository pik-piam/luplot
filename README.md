...
R package **luplot**, version **3.57.0**
...
Bodirsky B, Dietrich J, Krause M, Stevanovic M, Humpenoeder F, Weindl I, Baumstark L, Klein D, Rolinski S, Wang X (2024). _luplot: Landuse Plot Library_. R package version 3.57.0, <URL: https://github.com/pik-piam/luplot>.
