...
R package **luplot**, version **3.52.4**
...
Bodirsky B, Dietrich J, Krause M, Stevanovic M, Humpenoeder F, Weindl I, Baumstark L, Klein D, Rolinski S, Wang X (2022). _luplot: Landuse Plot Library_. R package version 3.52.4.
